...
if (floatval(phpversion()) < 5.3)			# is faster than version_compare()
	exit('<!doctype html><html dir=ltr lang=en><head><meta charset=utf-8><title>Forget the machine!</title><body><h1>Forget the machine!</h1><p>I found no PHP/5.3 or higher on it.');
